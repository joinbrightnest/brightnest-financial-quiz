...
export default function SharedHomePage({ affiliateCode }: SharedHomePageProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{backgroundColor: '#faf8f0'}}>
      ...
      {/* Hero Section */}
      <div className="flex flex-col px-4 sm:px-6 lg:px-8 pt-2 sm:pt-3 lg:pt-4 pb-20 sm:pb-20 lg:pb-24 min-h-[calc(100vh-80px)] justify-center" style={{backgroundColor: '#FAF8F4'}}>
