        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-18 sm:h-20">
            ...
            <div className="hidden lg:flex items-center">
              <Link href={getLink("/quiz/financial-profile")} className="bg-gradient-to-r from-[#1ABC9C] to-[#16a085] text-white px-6 py-2.5 rounded-full font-semibold text-sm hover:shadow-lg hover:scale-105 transition-all">
                Learn More
              </Link>
            </div>
          ...
          {isMobileMenuOpen && (
            <div className="lg:hidden border-t border-gray-200/50 backdrop-blur-md">
              <div className="px-4 py-4 space-y-2">
                ...
                <div className="pt-2">
                  <Link href={getLink("/quiz/financial-profile")} className="block w-full bg-gradient-to-r from-[#1ABC9C] to-[#16a085] text-white px-4 py-3 rounded-full font-semibold text-sm text-center shadow-md" onClick={() => setIsMobileMenuOpen(false)}>
                    Start Your Quiz
                  </Link>
                </div>
              </div>
