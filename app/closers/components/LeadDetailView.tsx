              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                ...
                {loadingTasks ? (
                  ...
                  <div className="text-center py-12 bg-slate-50 rounded-lg border border-slate-200">
                    ...
                    <p className="text-slate-600 text-lg mb-2">No tasks assigned to this lead yet</p>
                    <p className="text-slate-500 text-sm">Tasks are managed from the main Tasks page</p>
                  </div>
                ) : (
