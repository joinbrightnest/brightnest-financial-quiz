  ...
  return (
    <div className={`${isCollapsed ? 'w-16' : 'w-64'} bg-white border-r border-gray-200 flex-shrink-0 flex flex-col transition-all duration-300`}>
      ...
      <div className={`${isCollapsed ? 'p-4' : 'p-6'} border-b border-gray-200 flex items-center justify-between`}>
        <Link href="/closers/dashboard" className={`flex items-center ${isCollapsed ? 'justify-center' : 'space-x-3'}`}>
        ...
        <button
          ...
          className={`${isCollapsed ? 'mx-auto' : ''} p-1.5 hover:bg-gray-100 rounded-lg transition-colors`}
          title={isCollapsed ? 'Expand sidebar' : 'Collapse sidebar'}
        >
          <svg className={`w-4 h-4 text-gray-600 ${isCollapsed ? 'rotate-180' : ''} transition-transform`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <nav className="space-y-1">
          <Link
            ...
            className={`flex items-center ${isCollapsed ? 'justify-center' : 'space-x-3'} px-3 py-2.5 rounded-lg text-sm font-medium transition-colors group relative ${
      ...
      <div className={`${isCollapsed ? 'p-2' : 'p-4'} border-t border-gray-200`}>
        {!isCollapsed ? (
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <button
              onClick={onLogout}
              className="p-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors group relative"
              title="Logout"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
