...
export default function ConfirmationPage() {
  return (
    <div className="min-h-screen bg-[#F8F7F5]">
      ...
      <div className="bg-[#333333] py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-8 leading-tight">
            <span className="text-[#4CAF50]">CONGRATULATIONS!</span>
          </h2>

          {/* Confirmation Banner */}
          <div className="bg-[#4CAF50] rounded-lg py-4 px-6 max-w-2xl mx-auto mb-8">
          ...
          <div className="p-6">
            <div className="relative bg-gray-900 rounded-lg overflow-hidden aspect-video">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <button className="w-16 h-16 bg-[#4CAF50] rounded-full flex items-center justify-center shadow-lg hover:bg-[#45a049] transition-colors">
            ...
            <div className="mt-8 p-4 bg-gray-50 rounded-lg">
              <h6 className="font-semibold text-[#333333] mb-3">Pre-Call Checklist:</h6>
              <div className="space-y-2">
                {[
                  ...
                  <div key={index} className="flex items-center space-x-2">
                    <div className="w-4 h-4 border-2 border-[#4CAF50] rounded"></div>
