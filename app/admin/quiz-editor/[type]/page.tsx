...
export default function QuizEditor({ params }: QuizEditorProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
      {/* Modern Header */}
      <div className="bg-white border-b border-gray-200/60 backdrop-blur-sm sticky top-0 z-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Quiz Editor</p>
              </div>
            </div>
      ...
      {/* Modern Sidebar */}
      <div className="fixed left-0 top-20 w-72 h-[calc(100vh-5rem)] bg-white/80 backdrop-blur-sm border-r border-gray-200/60 z-40">
        <div className="p-6 h-full flex flex-col">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-xl transition-all duration-200 group border border-transparent hover:border-blue-200"
            >
            ...
            <button
              ...
              className="w-full flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 rounded-xl transition-all duration-200 group border border-transparent hover:border-emerald-200"
            >
            ...
            <button
              ...
              className="w-full flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-purple-50 hover:text-purple-700 rounded-xl transition-all duration-200 group border border-transparent hover:border-purple-200"
            >
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4">Quiz Statistics</h3>
            <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-700">Quiz content</p>
                    </div>
                  </div>
                  <span className="text-xl font-bold text-blue-900">{questions.length}</span>
                </div>
              </div>

              <div className="bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-xl p-4 border border-emerald-200/50">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <span className="text-sm font-semibold text-emerald-900">Articles</span>
                      <p className="text-xs text-emerald-700">Content pieces</p>
                    </div>
                  </div>
                  <span className="text-xl font-bold text-emerald-900">{articles.length}</span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200/50">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <span className="text-sm font-semibold text-purple-900">Loading Screens</span>
                      <p className="text-xs text-purple-700">Transition effects</p>
                    </div>
                  </div>
                  <span className="text-xl font-bold text-purple-900">{loadingScreens.filter(ls => ls.triggerQuestionId).length}</span>
                </div>
              </div>
            </div>
          </div>
                  ...
                  {isEditingLink ? (
                    <div className="flex items-center space-x-3">
                      ...
                      <button
                        ...
                        className="px-4 py-3 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-sm font-semibold shadow-lg"
                      >
                        Save
                      </button>
                      <button
                        ...
                        className="px-4 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-semibold shadow-lg"
                      >
                        Cancel
                      </button>
                    </div>
              ...
              return (
                <div key={question.id} className="space-y-6">
                  ...
                  <div
                    ...
                    className={`group relative bg-white rounded-2xl shadow-sm border transition-all duration-300 hover:shadow-lg ${draggedItem === question.id
                    ...
                    <div className="p-8 border-b border-gray-100">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-6">
                          <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-2xl text-xl font-bold shadow-lg">
                            {displayQuestionNumber}
                          </div>
                          <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Question {displayQuestionNumber}</h3>
                            <div className="flex items-center space-x-3">
                              <span className={`px-3 py-1.5 rounded-full text-xs font-semibold ${question.type === 'single' ? 'bg-blue-100 text-blue-800' :
                        ...
                        <div className="flex items-center space-x-3">
                          <button
                            ...
                            className={`flex items-center space-x-2 px-5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 ${editingQuestion === question.id
                          ...
                          <button
                            ...
                            className="flex items-center space-x-2 px-5 py-2.5 bg-red-50 text-red-700 rounded-lg hover:bg-red-100 transition-all duration-200 text-sm font-semibold border border-red-200"
                          >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="space-y-8">
                          ...
                          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200/50">
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="flex items-center space-x-2">
                                <button
                                  ...
                                  className="px-3 py-1.5 text-xs font-semibold text-blue-700 bg-blue-100 hover:bg-blue-200 rounded-lg transition-colors border border-blue-300"
                                ...
                                <button
                                  ...
                                  className="px-3 py-1.5 text-xs font-semibold text-purple-700 bg-purple-100 hover:bg-purple-200 rounded-lg transition-colors border border-purple-300"
                            ...
                            <div className="mt-3 p-3 bg-white/70 rounded-lg border border-blue-200/50">
                              <p className="text-xs text-gray-600">
                                💡 <strong>Tip:</strong> Use <code className="px-2 py-1 bg-blue-100 rounded text-blue-700 font-mono">{`{{name}}`}</code> or <code className="px-2 py-1 bg-purple-100 rounded text-purple-700 font-mono">{`{{email}}`}</code> to personalize questions with user data from previous answers.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-200/50">
                            ...
                            <select
                              ...
                              className="w-full px-4 py-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-gray-900 bg-white shadow-sm text-base"
                            >
                          ...
                          <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-2xl p-6 border border-purple-200/50">
                            <h4 className="text-base font-bold text-gray-900 mb-4">Button Options</h4>
                            <div className="space-y-4">
                              <div className="flex items-center space-x-3 p-3 bg-white/70 rounded-lg border border-purple-200/50">
                                <input
                                  type="checkbox"
                                  id={`skip-${question.id}`}
                                ...
                                />
                                <div className="flex-1">
                                  <label htmlFor={`skip-${question.id}`} className="text-sm font-semibold text-gray-700">
                                    Show Skip Option
                                  </label>
                                  <p className="text-xs text-gray-500">Users can skip this question</p>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center space-x-3 p-3 bg-white/70 rounded-lg border border-purple-200/50">
                                ...
                                />
                                <div className="flex-1">
                                  <label htmlFor={`continue-${question.id}`} className="text-sm font-semibold text-gray-700">
                                    Show Continue Button
                                  </label>
                                  <p className="text-xs text-gray-500">Requires answer selection before proceeding</p>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          {(question.continueButton || false) && (
                            <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-200/50 mt-4">
                              <h4 className="text-base font-bold text-gray-900 mb-4">Continue Button Customization</h4>
                              <div className="space-y-4">
                                <div>
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center space-x-3">
                                    <input
                                      ...
                                      className="w-16 h-12 rounded-lg cursor-pointer border border-gray-300 shadow-sm"
                                    />
                                    <input
                                      type="text"
                                      value={question.continueButtonColor || "#09727c"}
                          ...
                          <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl p-6 border border-teal-200/50">
                            <h4 className="text-base font-bold text-gray-900 mb-4">Additional Text Options</h4>
                            <div className="space-y-6">
                              <div>
                                ...
                                <textarea
                                  ...
                                  className="w-full px-4 py-3 text-sm border border-gray-300 rounded-lg text-gray-900 resize-none bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
                                  placeholder="Optional text to display under answer options (smaller, grey text)"
                                  rows={2}
                                />
                                <p className="text-xs text-gray-500 mt-2 p-2 bg-white/70 rounded border border-teal-200/50">
