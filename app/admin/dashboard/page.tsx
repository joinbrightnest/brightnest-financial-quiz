        ...
        <div className={`flex-1 overflow-y-auto overflow-x-visible ${sidebarCollapsed ? 'p-2' : 'p-4'}`}>
          ...
          <nav className="space-y-3">
            ...
            <button
              ...
              className={`w-full flex items-center ${sidebarCollapsed ? 'justify-center' : 'space-x-3'} ${sidebarCollapsed ? 'px-2 py-2.5' : 'px-3 py-3 rounded-lg'} transition-colors group relative ${activeSection === 'quiz-analytics'
                ? sidebarCollapsed
            ...
            <button
              ...
              className={`w-full flex items-center ${sidebarCollapsed ? 'justify-center' : 'space-x-3'} ${sidebarCollapsed ? 'px-2 py-2.5' : 'px-3 py-3 rounded-lg'} transition-colors group relative ${activeSection === 'crm'
                ? sidebarCollapsed
                  ? 'bg-slate-700 text-white'
                  : 'bg-slate-700 text-white border-l-4 border-indigo-500'
                : sidebarCollapsed
            ...
            <button
              ...
              className={`w-full flex items-center ${sidebarCollapsed ? 'justify-center' : 'space-x-3'} ${sidebarCollapsed ? 'px-2 py-2.5' : 'px-3 py-3 rounded-lg'} transition-colors group relative ${activeSection === 'ceo-analytics'
                ? sidebarCollapsed
                  ? 'bg-slate-700 text-white'
                  : 'bg-slate-700 text-white border-l-4 border-indigo-500'
                : sidebarCollapsed
          ...
          <div className="mt-8 pt-6 border-t border-slate-700">
            ...
            <button
              ...
              className={`w-full flex items-center ${sidebarCollapsed ? 'justify-center' : 'space-x-3'} ${sidebarCollapsed ? 'px-2 py-2.5' : 'px-3 py-3 rounded-lg'} transition-colors group relative ${activeSection === 'closer-management'
                ? sidebarCollapsed
                  ? 'bg-slate-700 text-white'
                  : 'bg-slate-700 text-white border-l-4 border-indigo-500'
                : sidebarCollapsed
            ...
            <button
              ...
              className={`w-full flex items-center ${sidebarCollapsed ? 'justify-center' : 'space-x-3'} ${sidebarCollapsed ? 'px-2 py-2.5' : 'px-3 py-3 rounded-lg'} transition-colors group relative ${activeSection === 'settings'
                ? sidebarCollapsed
                  ? 'bg-slate-700 text-white'
                  : 'bg-slate-700 text-white border-l-4 border-indigo-500'
                : sidebarCollapsed
                  ...
                  <div className="bg-gradient-to-b from-gray-50 to-white px-6 py-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                      ...
                      <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 p-5">
                        ...
                        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 text-center">TOTAL DEAL AMOUNT</div>
                        <div className="text-xs text-gray-400 text-center">Open + Closed deals</div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 p-5">
                        ...
                        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 text-center">WEIGHTED DEAL AMOUNT</div>
                        <div className="text-xs text-gray-400 text-center">To be determined</div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 p-5">
                        ...
                        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 text-center">OPEN DEAL AMOUNT</div>
                        <div className="text-xs text-gray-400 text-center">Potential + actual open deals</div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 p-5">
                        ...
                        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 text-center">CLOSED DEAL AMOUNT</div>
                        <div className="text-xs text-gray-400 text-center">Closed deals with sale values</div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 p-5">
                        ...
                        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 text-center">NEW DEAL AMOUNT</div>
                        <div className="text-xs text-gray-400 text-center">Deals with no outcome yet</div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 p-5">
                        ...
                        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 text-center">AVERAGE DEAL AGE</div>
