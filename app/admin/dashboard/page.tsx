          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-2 px-3">
              <div className="space-y-1">
                <div className="text-xs font-medium text-gray-600 mb-2">Login Pages</div>
                <a
              ...
              <div className="space-y-1">
                <div className="text-xs font-medium text-gray-600 mb-2">Signup Pages</div>
                <a
              ...
              <div className="space-y-1">
                <div className="text-xs font-medium text-gray-600 mb-2">Public Pages</div>
                <a
                  href="/"
                  target="_blank"
                  rel="noopener noreferrer"
