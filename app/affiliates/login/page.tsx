          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="mt-4 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/affiliates/signup" className="font-medium text-blue-600 hover:text-blue-500">
                  Sign up here
                </Link>
              </p>
            </div>
            ...
            <div className="mt-4 text-center">
              <Link href="/affiliates/forgot-password" className="text-sm text-blue-600 hover:text-blue-500">
