      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center py-5">
          ...
          <div className="relative">
            ...
            {showMenu && (
              <div className="absolute right-0 mt-3 w-56 bg-white/95 backdrop-blur-sm rounded-xl shadow-xl ring-1 ring-gray-200/50 border border-gray-100/50 z-50 overflow-hidden">
                <div className="py-2">
