          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6 mb-6">
              ...
              {debts.map((debt, index) => (
                <div key={debt.id} className="mb-6 p-6 border border-slate-200 rounded-lg bg-slate-50">
              ...
              <button
                onClick={addDebt}
                className="w-full inline-flex items-center justify-center gap-2 bg-teal-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-teal-700 transition-colors"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
