                    ...
                    <div className="text-slate-700 leading-relaxed text-base sm:text-lg space-y-6">
                      {(() => {
                        ...
                        while (i < paragraphs.length) {
                          ...
                          // Check if paragraph starts with bold text in "How to fix it" section, "How to talk about money" section, or "How to implement it" section - create a step card
                          if (para.match(/^\*\*/) && (s.title.toLowerCase().includes('fix it') || s.title.toLowerCase().includes('how to talk about money') || s.title.toLowerCase().includes('how to implement it'))) {
