        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-18 sm:h-20">
            ...
            <div className="hidden lg:flex items-center space-x-1">
              <Link href="/about" className="px-4 py-2 text-[#FF6B6B] font-semibold text-sm rounded-lg bg-[#FF6B6B]/10">
                About Us
              </Link>
          ...
          {isMobileMenuOpen && (
            <div className="lg:hidden border-t border-gray-200/50 backdrop-blur-md">
              <div className="px-4 py-4 space-y-2">
                <Link href="/about" className="block px-4 py-3 text-[#FF6B6B] font-semibold text-sm rounded-lg bg-[#FF6B6B]/10" onClick={() => setIsMobileMenuOpen(false)}>About Us</Link>
