        ...
        <div className="prose prose-lg max-w-none relative">
          <div className="space-y-6 sm:space-y-8 lg:space-y-12">
              ...
              <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
                <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                  <h2 className="text-xl sm:text-2xl font-bold text-slate-900">3. Eligibility and Account Responsibilities</h2>
                </div>
                
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">3.1 Eligibility.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">3.2 Account Creation.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">3.3 User Conduct.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">You agree not to:</p>
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">3.4 Suspension or Termination.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">4.1 Ownership.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">4.2 Limited License.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">4.3 User Submissions.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">4.4 Trademarks.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
                <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                  <h2 className="text-xl sm:text-2xl font-bold text-slate-900">5. Payments</h2>
                </div>
                
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">5.1 General.</h3>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">5.2 Currency.</h3>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed mb-3 sm:mb-4">
                  All transactions are denominated in United States Dollars (USD).
                </p>

                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">5.3 No Refunds.</h3>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">5.4 Taxes.</h3>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed mb-3 sm:mb-4">
              ...
              <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
                <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                  <h2 className="text-xl sm:text-2xl font-bold text-slate-900">6. Disclaimers</h2>
                </div>
                
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">6.1 Educational Purpose Only.</h3>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">6.2 No Guarantee of Results.</h3>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">6.3 Accuracy of Information.</h3>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">6.4 Third-Party Links and Integrations.</h3>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">6.5 "As Is" Provision.</h3>
                <p className="text-sm sm:text-base text-slate-800 leading-relaxed mb-3 sm:mb-4">
              ...
              <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
                <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                  <h2 className="text-xl sm:text-2xl font-bold text-slate-900">8. Indemnification</h2>
                </div>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
                <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                  <h2 className="text-xl sm:text-2xl font-bold text-slate-900">9. Dispute Resolution and Governing Law</h2>
                </div>
                
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">9.1 Good Faith Resolution.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">9.2 Binding Arbitration.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">9.3 Governing Law.</h3>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
                <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                  <h2 className="text-xl sm:text-2xl font-bold text-slate-900">11. Modifications to the Terms</h2>
                </div>
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
                ...
                <div className="bg-gradient-to-br from-slate-50 to-teal-50/30 rounded-xl p-4 sm:p-6 mt-3 sm:mt-4 border border-slate-200/60">
