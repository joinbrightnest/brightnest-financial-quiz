...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      {/* Main Content */}
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 relative">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 relative">
          <div className="inline-block mb-3 sm:mb-4">
            <span className="text-xs font-semibold text-teal-600 uppercase tracking-wider bg-teal-50 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full">Legal</span>
          </div>
        ...
        <div className="prose prose-lg max-w-none">
            ...
            {/* Introduction */}
            <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
              <p className="text-slate-600 leading-relaxed mb-4 sm:mb-6 text-xs sm:text-sm">
            ...
            <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
              <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">1.1 Information You Provide Directly</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 ml-3 sm:ml-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">1.2 Automatically Collected Information</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 ml-3 sm:ml-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">1.3 Information from Third Parties</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4 space-y-1.5 sm:space-y-2 ml-3 sm:ml-4">
            ...
            <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
              ...
              <div className="overflow-x-auto mb-3 sm:mb-4 rounded-lg border border-slate-200/60">
                <table className="min-w-full">
                  <thead className="bg-gradient-to-r from-teal-50 to-amber-50">
                    <tr>
                      <th className="border-b border-slate-200 px-2 py-2 sm:px-4 sm:py-3 text-left text-xs sm:text-sm font-semibold text-slate-900">Purpose</th>
                      <th className="border-b border-slate-200 px-2 py-2 sm:px-4 sm:py-3 text-left text-xs sm:text-sm font-semibold text-slate-900">Data Types Involved</th>
                      <th className="border-b border-slate-200 px-2 py-2 sm:px-4 sm:py-3 text-left text-xs sm:text-sm font-semibold text-slate-900">Description</th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-slate-100">
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700 font-medium">Provisioning & Operation</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">Account info, usage data, device data</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">To deliver the Service, authenticate you, maintain your account, and ensure service functionality.</td>
                    </tr>
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700 font-medium">Personalization & Insights</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">Behavior logs, user input, inferred data</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">To tailor your experience, suggest content, generate insights, and adapt to your progress.</td>
                    </tr>
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700 font-medium">Improvement & Development</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">Usage data, feedback, crash logs</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">To assess performance, troubleshoot issues, test new features, and improve the Service.</td>
                    </tr>
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700 font-medium">Customer Support</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">Contact communications, account info</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">To respond to your inquiries, troubleshoot, and assist with support requests.</td>
                    </tr>
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700 font-medium">Payment & Billing</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">Payment data, transaction records</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">To process transactions, prevent fraud, enforce payment terms, and manage financial operations.</td>
                    </tr>
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700 font-medium">Marketing & Communications</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">Email, preferences, usage data</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">To send updates, promotional offers, newsletters, surveys, and to inform you about new features (you may opt out).</td>
                    </tr>
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700 font-medium">Legal & Compliance</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">Account info, logs, communications</td>
                      <td className="px-2 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm text-slate-700">To comply with legal obligations, enforce our Terms, or protect rights, safety, or property.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
              <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900">3. Sharing & Disclosure of Information</h2>
              </div>
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
            ...
            <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
              <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900">4. Data Retention</h2>
              </div>
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
            ...
            <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
              <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900">5. Your Privacy Rights & Choices</h2>
              </div>
              
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">5.1 Account Controls & Preferences</h3>
              <ul className="list-disc list-inside text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4 space-y-1.5 sm:space-y-2">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">5.2 Deletion & Erasure</h3>
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">5.3 Data Access & Portability</h3>
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">5.4 Opt-Out of Tracking & Cookies</h3>
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">5.5 Do-Not-Track Signals & Similar Mechanisms</h3>
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
            ...
            <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
              <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900">6. International Data Transfers</h2>
              </div>
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
            ...
            <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
              <div className="relative pl-3 sm:pl-4 mb-4 sm:mb-6">
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-teal-500 to-amber-400 rounded-full"></div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900">8. Security Measures</h2>
              </div>
              <p className="text-sm sm:text-base text-slate-700 leading-relaxed mb-3 sm:mb-4">
            ...
            <section className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-slate-200/60 shadow-sm">
              ...
              <div className="bg-gradient-to-br from-slate-50 to-teal-50/30 rounded-lg p-4 sm:p-6 mt-3 sm:mt-4">
