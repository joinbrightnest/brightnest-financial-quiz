...
export default function CEOAnalytics({ initialData }: CEOAnalyticsProps) {
  ...
  // Render logic moved to main return to keep Header visible during loading
  ...
  return (
    <>
      ...
      <AnalyticsPageHeader
        ...
        subtitle="Advanced performance tracking and revenue attribution"
        onRefresh={() => fetchCEOAnalytics(true)}
        ...
        tabs={[
          ...
          },
          {
            ...
            badge: pendingAffiliates.length,
          },
          {
            id: "payouts",
        ...
        onTabChange={(tabId) => setActiveSection(tabId as "overview" | "affiliates" | "pending" | "payouts")}
      >
        {/* Date Range Filter */}
          ...
          <div className="text-center py-12">
            <div className="bg-white border border-red-200 rounded-2xl p-8 max-w-md mx-auto shadow-lg">
              ...
              <button
                ...
                className="inline-flex items-center px-6 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700"
              >
                Try Again
              </button>
            </div>
