            ...
            <div className={`${collapsed ? 'w-14' : 'w-56'} bg-gradient-to-b from-slate-800 to-slate-900 border-r border-slate-700 flex flex-col transition-all duration-300 ease-in-out
                ...
                <div className={`flex-1 overflow-y-auto overflow-x-visible ${collapsed ? 'p-2' : 'p-3'}`}>
                    <nav className="space-y-2">
                        ...
                        <button onClick={() => { onSectionChange('quiz-analytics'); setMobileMenuOpen(false); }} className={getButtonClasses('quiz-analytics')}>
                        ...
                        <button onClick={() => { onSectionChange('crm'); setMobileMenuOpen(false); }} className={getButtonClasses('crm')}>
                        ...
                        <button onClick={() => { onSectionChange('ceo-analytics'); setMobileMenuOpen(false); }} className={getButtonClasses('ceo-analytics')}>
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-700">
                        ...
                        <button onClick={() => { onSectionChange('closer-management'); setMobileMenuOpen(false); }} className={getButtonClasses('closer-management')}>
                        ...
                        <button onClick={() => { onSectionChange('settings'); setMobileMenuOpen(false); }} className={getButtonClasses('settings')}>
