        ...
        <>
          ...
          <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
            <div className="flex-1 flex flex-col min-h-0 w-full px-4 sm:px-6 lg:px-8 py-8">
              ...
              {/* Stats Cards - Updated Professional Design */}
              <div className="flex-shrink-0 grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                {/* Total Calls */}
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col justify-between hover:shadow-md transition-shadow duration-200">
                  <div>
                    <div className="flex items-center justify-between">
                    ...
                    <p className="text-3xl font-bold text-gray-900 mt-2">{closer.totalCalls}</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col justify-between hover:shadow-md transition-shadow duration-200">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-900 mt-2">{closer.totalConversions}</p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-baseline mt-2">
                      <p className="text-3xl font-bold text-gray-900">
                        {typeof closer.conversionRate === 'number' ? closer.conversionRate.toFixed(1) : '0.0'}%
                      </p>
                    </div>
                  </div>
                </div>
